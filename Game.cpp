...
bool decodeDirection(char ch, int& dir) //only used in Game type
{
    switch (tolower(ch))
    {
...
bool recommendMove(const Arena& a, int r, int c, int& bestDir) //only used in Game type
{
...
int computeDanger(const Arena& a, int r, int c) //only used in Game type
{
